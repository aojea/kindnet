...
import (
	v1alpha1 "github.com/aojea/kindnet/apis/generated/clientset/versioned/typed/config/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeKindnetV1alpha1 struct {
	*testing.Fake
}

func (c *FakeKindnetV1alpha1) Configurations(namespace string) v1alpha1.ConfigurationInterface {
